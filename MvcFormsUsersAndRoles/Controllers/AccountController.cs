...
namespace MvcFormsUsersAndRoles.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            {
                return RedirectToAction("Unautherorized", "Account");
            }
        ...
        public string TokenError()
        {
            ...
            return string.Format("Sorry {0}, I'm confused. {1}", User.Identity.Name, User.Identity.GetUserId());
        }

        [AllowAnonymous]
        public ActionResult Unautherorized()
        {
            //var x = User.IsInRole("Admin");
            //return string.Format("Sorry {0}, you can't come here. {1}", User.Identity.Name, User.Identity.GetUserId());
            return View();
        }
